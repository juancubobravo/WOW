...
CREATE TABLE CLIENTE (ID VARCHAR NOT NULL, CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHAALTA DATE NOT NULL, FECHABAJA DATE, IDENTIFICACION VARCHAR NOT NULL UNIQUE, PAIS VARCHAR NOT NULL, TIPOCLIENTE VARCHAR NOT NULL, PRIMARY KEY (ID))
CREATE TABLE CUENTA (IBAN VARCHAR NOT NULL, SWIFT VARCHAR, PRIMARY KEY (IBAN))
CREATE TABLE CUENTAFINTECH (IBAN VARCHAR NOT NULL, CLASIFICACION VARCHAR, ESTADO VARCHAR NOT NULL, FECHAAPERTURA DATE NOT NULL, FECHACIERRE DATE, SWIFT VARCHAR, CLIENTE_ID VARCHAR NOT NULL, PRIMARY KEY (IBAN))
...
CREATE TABLE POOLEDACCOUNT (IBAN VARCHAR NOT NULL, CLASIFICACION VARCHAR, ESTADO VARCHAR NOT NULL, FECHAAPERTURA DATE NOT NULL, FECHACIERRE DATE, SWIFT VARCHAR, CLIENTE_ID VARCHAR NOT NULL, PRIMARY KEY (IBAN))
...
CREATE TABLE INDIVIDUAL (ID VARCHAR NOT NULL, APELLIDO VARCHAR NOT NULL, CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHAALTA DATE NOT NULL, FECHABAJA DATE, FECHANACIMIENTO DATE, IDENTIFICACION VARCHAR NOT NULL UNIQUE, NOMBRE VARCHAR NOT NULL, PAIS VARCHAR NOT NULL, TIPOCLIENTE VARCHAR NOT NULL, PRIMARY KEY (ID))
CREATE TABLE USUARIO (NOMBRE VARCHAR NOT NULL, CONTRAS VARCHAR NOT NULL, TIPO VARCHAR NOT NULL, AUTORIZADA_IDAUTORIZADA VARCHAR, CLIENTE_ID VARCHAR, PRIMARY KEY (NOMBRE))
CREATE TABLE SEGREGADA (IBAN VARCHAR NOT NULL, CLASIFICACION VARCHAR, COMISION VARCHAR, ESTADO VARCHAR NOT NULL, FECHAAPERTURA DATE NOT NULL, FECHACIERRE DATE, SWIFT VARCHAR, CLIENTE_ID VARCHAR NOT NULL, CUENTAREFERENCIA_IBAN VARCHAR, PRIMARY KEY (IBAN))
...
ALTER TABLE AUTORIZACION ADD CONSTRAINT FK_AUTORIZACION_EmpresaID FOREIGN KEY (EmpresaID) REFERENCES EMPRESA (ID)
